...
describe("Form", () => {
  ...
  it("validates that the interviewer cannot be null", () => {
    ...
    const { getByText } = render(<Form student={"Lydia Miller-Jones"} interviewer={null} interviewers={interviewers} onSave={onSave} />);
  ...
  it("calls onSave function when the name and interviewer is defined", () => {
    ...
    const { queryByText, getByText } = render(<Form interviewer={1} student={"Lydia Miller-Jones"} interviewers={interviewers} onSave={onSave} />);
